                ...
                <div className='cardOneDoacao'>
                    <Card style={{ width: '18rem', height: "31rem" }}>
                        ...
                        <Card.Body>
                          ...
                          <a href= 'downloads/arquivos/Artigo%201-%20O%20Espelho%20na%20Parede%20-%20Paz.pdf' target="blank">  <Button variant="success" style={{ marginTop: "22px" }}>Download</Button></a>
                        </Card.Body>
                ...
                <div className='cardDoisInscrever'>
                    <Card style={{ width: '18rem', height: "31rem" }}>
                        ...
                        <Card.Body>
                           ...
                           <a href= 'downloads/arquivos/Artigo%202-%20O%20Empres%C3%A1rio%20e%20a%20Pedra%20M%C3%A1gica%20-%20Aprecia%C3%A7%C3%A3o.pdf' target="blank"> <Button variant="success" style={{ marginTop: "22px" }}>Download</Button></a>
                        </Card.Body>
                    </Card>
                </div >
                ...
                <div className='cardOneDoacao'>
                    <Card style={{ width: '18rem', height: "31rem" }}>
                        ...
                        <Card.Body>
                           ...
                           <a href='downloads/arquivos/Artigo_5-_A_Hist%C3%B3ria_da_Formiga_-_Clareza.pdf' target="blank"> <Button variant="success">Download</Button></a>
                        </Card.Body>
                    </Card>
                </div >
                <div className='cardDoisInscrever'>
                ...
                <div className='cardTresVoluntario'>
                    <Card style={{ width: '18rem', height: "31rem" }}>
                        ...
                        <Card.Body>
                            ...
                            <a href="downloads/arquivos/Artigo_7-_Os_Tr%C3%AAs_Irm%C3%A3os_que_Encontraram_Ouro_-_Dignidade.pdf " target="blank"
                            ><Button variant="success" style={{ marginTop: "20px" }}>Download</Button></a>
                        </Card.Body>
                    </Card>
                </div>
                <div className='cardTresVoluntario'>
                    <Card style={{ width: '18rem', height: "31rem" }}>
                        ...
                        <Card.Body>
                           ...
                           <a href='/downloads/arquivos/Artigo_8-_As_%C3%81rvores_do_Jardim_da_Vida_-_Escolha.pdf' target="blank"> <Button variant="success" style={{ marginTop: "20px" }}>Download</Button></a>
                        </Card.Body>
                    </Card>
                </div>
                ...
                <div className='cardOneDoacao'>
                    <Card style={{ width: '18rem', height: "31rem" }}>
                        ...
                        <Card.Body>
                            ...
                            <a href='/downloads/arquivos/Artigo%209-%20A%20Porta%20At%C3%A9%20Voc%C3%AA%20-%20Esperan%C3%A7a%20.pdf' target="blank"> <Button variant="success">Download</Button></a>
                        </Card.Body>
                    </Card>
                </div >
                <div className='cardDoisInscrever'>
                ...
                <div className='cardOneDoacao'>
                    <Card style={{ width: '18rem', height: "31rem" }}>
                        ...
                        <Card.Body>
                            ...
                            <a href='/downloads/arquivos/Artigo%201%20-%20Paz%20%C3%A9%20...%20-%20Paz.pdf' target="blank"> <Button variant="success">Download</Button></a>
                        </Card.Body>
                    </Card>
                </div >
                <div className='cardDoisInscrever'>
