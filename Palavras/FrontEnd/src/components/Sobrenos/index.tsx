            ...
            <div className='containerGeral'>
                <div className='containerSobreNos'>
                    ...
                    <div className='textoSobreNos'>
                        <h1>Sobre nós</h1>
                        <p> <b>A ONG Palavras de Paz</b> é uma entidade sem fins lucrativos, gerida por voluntários que fazem gratuitamente o Programa de Educação para a Paz, uma série inovadora de workshops baseados em vídeos que ajudam as pessoas a descobrirem sua própria força interior e paz pessoal. Comece a oferecer o programa agora ou se comunique com um representante de suporte da TPRF clicando aqui para saber mais sobre como você pode usar este poderoso programa.</p>
                        <div>
